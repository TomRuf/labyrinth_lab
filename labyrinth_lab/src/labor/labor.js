...
function confirmDeleteExp(id) {
    ...
    document.getElementById("confirm-modal-text").innerHTML = `Bist du dir sicher dass du "<b>${experiments[getIndexOf(id)].expTitle}</b>" löschen willst? Dieser Vorgang kann nicht rückgängig gemacht werden.`;
}
